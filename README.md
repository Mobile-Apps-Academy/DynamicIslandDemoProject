...
A demo project showcasing the use of dynamic island, Developed using SwiftUI.
...
1. Clone the repo
   ```sh
   git clone https://github.com/Mobile-Apps-Academy/DynamicIslandDemoProject.git
   ```
